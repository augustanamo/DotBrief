package com.briefwidget.domain

import android.content.Context
import com.briefwidget.data.ingest.AgendaEvent
import com.briefwidget.data.ingest.BriefInput
import com.briefwidget.data.ingest.CalendarSource
import com.briefwidget.data.ingest.CapturedItem
import com.briefwidget.data.ingest.NewsItem
import com.briefwidget.data.ingest.RssSource
import com.briefwidget.data.ingest.SpokenTime
import com.briefwidget.data.ingest.WeatherSource
import com.briefwidget.data.ingest.isAnniversary
import com.briefwidget.data.llm.LlmClient
import com.briefwidget.data.llm.LlmResult
import com.briefwidget.data.llm.PromptBuilder
import com.briefwidget.data.local.dao.CapturedNotificationDao
import com.briefwidget.data.notification.IngestKind
...
class GenerateBriefUseCase(
    ...
    private suspend fun collect(settings: UserSettings): BriefInput = coroutineScope {
        ...
        val capturedJob = async(Dispatchers.IO) {
            if (BriefSource.TRIP !in sources && BriefSource.PACKAGE !in sources) {
                emptyList<com.briefwidget.data.local.entity.CapturedNotification>() to null
            } else {
    ...
    private fun com.briefwidget.data.local.entity.CapturedNotification.toItem() = CapturedItem(
        kind = kind,
        appLabel = appLabel,
        code = code,
        timeText = timeText,
